import { ArrowLeft, Plus, X, GripVertical, Palette } from 'lucide-react';
...
export default function NewSchemaForm({ 
    ...
    // Color schemes modernos inspirados en la imagen
    const colorSchemes: ColorScheme[] = [
        {
            name: 'modern-purple',
            gradient: 'from-violet-50 via-purple-50 to-fuchsia-50',
            cardGradient: 'from-white/90 to-purple-50/80',
        ...
        },
        {
            ...
            cardGradient: 'from-white/90 to-blue-50/80',
        ...
        },
        {
            ...
            cardGradient: 'from-white/90 to-pink-50/80',
        ...
        },
        {
            ...
            cardGradient: 'from-white/90 to-emerald-50/80',
        ...
        },
        {
            ...
            cardGradient: 'from-white/90 to-orange-50/80',
        ...
        },
        {
            ...
            cardGradient: 'from-white/90 to-indigo-50/80',
    ...
    const currentColors: ColorScheme = colorSchemes[colorSchemeIndex];
    ...
    const handleSaveProgress = (): void => {
        ...
        try {
            ...
            // Validar que no exista un schema con el mismo nombre
            const duplicateName = progresses.some(
                progress => progress.formData.schemaName.trim().toLowerCase() === formData.schemaName.trim().toLowerCase()
            );
            
            if (duplicateName) {
                showToast('Ya existe un schema guardado con ese nombre. Por favor, usa otro nombre.', 'warning');
                return;
            }
    ...
    return (
        <>
            <div className={`min-h-screen bg-gradient-to-br ${currentColors.gradient} p-4 sm:p-6 transition-all duration-500`}>
                <div className="max-w-6xl mx-auto">
                {/* Header con glassmorphism */}
                <div className={`bg-gradient-to-r ${currentColors.cardGradient} backdrop-blur-xl rounded-2xl shadow-xl ${currentColors.shadow} border ${currentColors.border} p-6 sm:p-8 mb-6`}>
                    <div className="flex items-center justify-between mb-6">
                        <button
                            onClick={() => setShowNewSchemaForm(false)}
                            className={`flex items-center gap-2 ${currentColors.textSecondary} hover:${currentColors.textAccent} transition-colors cursor-pointer`}
                        >
                            ...
                            <div className="flex gap-2">
                                {colorSchemes.map((scheme, index) => (
                                    <button
                                        ...
                                        className={`w-8 h-8 rounded-full bg-gradient-to-r ${scheme.accentGradient} transition-all cursor-pointer ${
                    ...
                    <div className="mt-6 w-full bg-white/50 rounded-full h-2 overflow-hidden">
                        <motion.div 
                            className={`h-full bg-gradient-to-r ${currentColors.accentGradient} rounded-full`}
                            initial={{ width: 0 }}
                ...
                <form onSubmit={handleNextStep}>
                    <div className={`bg-gradient-to-br ${currentColors.cardGradient} backdrop-blur-xl rounded-2xl shadow-xl ${currentColors.shadow} border ${currentColors.border} p-6 sm:p-8`}>
                                ...
                                >
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <button
                                            ...
                                            className={`w-full py-3 border-2 border-dashed ${currentColors.border} ${currentColors.hover} rounded-xl ${currentColors.textAccent} font-medium flex items-center justify-center gap-2 transition-all hover:bg-white/30 cursor-pointer`}
                                        >
                                            ...
                                            <div key={optionIndex} className={`p-5 bg-white/60 backdrop-blur-sm border ${currentColors.border} rounded-xl`}>
                                                ...
                                                <div className="flex gap-2 mb-3">
                                                    ...
                                                    <button
                                                        ...
                                                        className={`px-4 py-2.5 bg-gradient-to-r ${currentColors.accentGradient} text-white rounded-lg font-medium hover:shadow-lg transition-all cursor-pointer`}
                                                    >
                                                        <Plus className="w-5 h-5" />
                                                    </button>
                                                </div>
                                                    ...
                                                    {(configLabels[option] || []).map((label, labelIndex) => (
                                                        ...
                                                        >
                                                            ...
                                                            <button
                                                                ...
                                                                className="text-red-500 hover:text-red-700 transition-colors opacity-0 group-hover:opacity-100 cursor-pointer"
                                                            >
                                                                <X className="w-4 h-4" />
                                                            </button>
                                                        </motion.div>
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex gap-2">
                                            ...
                                            <button
                                                ...
                                                className={`px-6 py-3 bg-gradient-to-r ${currentColors.accentGradient} text-white rounded-xl font-medium hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer`}
                                            >
                                                <Plus className="w-5 h-5" />
                                            </button>
                                        </div>
                            ...
                            <div className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3">
                                {currentStep > 1 && (
                                    <button
                                        ...
                                        className={`px-6 py-3 border-2 ${currentColors.border} ${currentColors.textPrimary} rounded-xl font-medium hover:bg-white/50 transition-all cursor-pointer`}
                                    >
                                        ← Atrás
                                    </button>
                                )}
                                ...
                                <button
                                    ...
                                    className={`px-8 py-3 bg-gradient-to-r ${currentColors.accentGradient} text-white rounded-xl font-medium hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer ${
                                        currentStep === 1 ? 'w-full sm:w-auto sm:ml-auto' : 'w-full sm:w-auto'
                                    }`}
                                >
                            ...
                            <div className="flex justify-start gap-2 pt-3 border-t border-slate-200">
                                <div className="relative">
                                    <button
                                        ...
                                        className={`px-4 py-3 border ${currentColors.border} ${currentColors.textPrimary} rounded-lg font-medium hover:bg-white/50 transition-all flex items-center justify-center cursor-pointer`}
                                    >
                                ...
                                <div className="relative">
                                    <button
                                        ...
                                        onMouseLeave={() => setHoveredButton(null)}
                                        className={`px-4 py-3 bg-gradient-to-r ${currentColors.accentGradient} text-white rounded-lg font-medium hover:shadow-lg transition-all flex items-center justify-center cursor-pointer`}
                                    >
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {showSavedProgressModal && (
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                <motion.div
                    ...
                    className={`bg-gradient-to-br ${currentColors.cardGradient} backdrop-blur-xl rounded-2xl shadow-2xl border ${currentColors.border} max-w-3xl w-full max-h-[80vh] overflow-hidden`}
                >
                    {/* Header del Modal */}
                    <div className={`p-6 border-b ${currentColors.border}`}>
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                ...
                                className={`p-2 rounded-lg ${currentColors.textSecondary} hover:bg-white/50 transition-all cursor-pointer`}
                            >
                                <X className="w-6 h-6" />
                            </button>
                        </div>
                                        ...
                                        <div className="flex items-start justify-between gap-4">
                                            <div className="flex-1 cursor-pointer" onClick={() => handleSelectProgress(progress)}>
                                                <div className="flex items-center gap-3 mb-2">
                                                    ...
                                                    <span className={`px-2 py-1 text-xs font-medium rounded-md bg-gradient-to-r ${currentColors.accentGradient} text-white`}>
                                            ...
                                            <button
                                                ...
                                                className="p-2 text-red-500 hover:bg-red-50 rounded-lg transition-all opacity-0 group-hover:opacity-100 cursor-pointer"
        ...
        {confirmModal.isOpen && (
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                <motion.div
                    ...
                    animate={{ opacity: 1, scale: 1 }}
                    exit={{ opacity: 0, scale: 0.9 }}
                    className={`bg-gradient-to-br ${currentColors.cardGradient} backdrop-blur-xl rounded-2xl shadow-2xl border ${currentColors.border} max-w-md w-full overflow-hidden`}
                >
                    {/* Header del Modal */}
                    <div className={`p-6 border-b ${currentColors.border}`}>
                        <div className="flex items-center gap-3">
                            ...
                            {confirmModal.type === 'info' && (
                                <div className={`w-12 h-12 rounded-full bg-gradient-to-r ${currentColors.accentGradient} flex items-center justify-center flex-shrink-0`}>
                                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {/* Footer con botones */}
                    <div className={`p-6 border-t ${currentColors.border} flex gap-3 justify-end`}>
                        <button
                            onClick={confirmModal.onCancel}
                            className={`px-6 py-2.5 border ${currentColors.border} ${currentColors.textPrimary} rounded-lg font-medium hover:bg-white/50 transition-all cursor-pointer`}
                        >
                            Cancelar
                        </button>
                        <button
                            ...
                            className={`px-6 py-2.5 rounded-lg font-medium transition-all cursor-pointer ${
                                confirmModal.type === 'danger' 
                                    ...
                                    : `bg-gradient-to-r ${currentColors.accentGradient} text-white hover:shadow-lg`
                            }`}
                        >
                            Confirmar
                        </button>
            ...
            <AnimatePresence>
                {toasts.map((toast) => {
                    const toastStyles = {
                        ...
                        info: `bg-gradient-to-r ${currentColors.accentGradient} text-white`
                    };
